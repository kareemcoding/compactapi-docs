...
Every Mintlify site needs a `mint.json` file with the core configuration settings. Learn more Welcome the [properties](#properties) below.
...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more Welcome API pages at [API Components](/api-playground/demo).
...
<ResponseField name="feedback" type="Feedback">
  ...
  <Expandable title="Feedback">
    ...
    Enables a button to allow users to raise an issue Welcome the documentation
    </ResponseField>
  </Expandable>
</ResponseField>
